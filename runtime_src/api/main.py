    ...
    <div class="wrap">
      <div class="window">
        ...
        <section class="filters">
          ...
          <div class="muted">Live URL scraping: Jumia + Kilimall. eBay and Shopify API modes are live beta; WooCommerce API mode is live. Other API platforms require integration setup.</div>
